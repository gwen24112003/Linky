  ...
  '@graph': [
    {
      ...
      telephone: '+33615756549',
      founder: {
        '@type': 'Person',
        name: 'Enzo Monnier',
        jobTitle: 'Consultant ops BTP second œuvre',
        url: 'https://www.linkedin.com/in/enzo-monnier-7524ab205/',
      },
      address: {
        '@type': 'PostalAddress',
        streetAddress: '25 allée du petit domaine',
        postalCode: '35590',
        addressLocality: "L'Hermitage",
