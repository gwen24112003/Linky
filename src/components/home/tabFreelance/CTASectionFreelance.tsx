      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-10 leading-tight">
            Vous êtes expert en organisation ?
          </h2>

          <Link to="/experts-contact" className="inline-flex items-center gap-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-8 py-4 text-lg rounded-lg font-semibold hover:scale-105 transition-all duration-200 hover:shadow-xl group">
