...
export const ProcessSectionEntreprise: React.FC = () => {
  const processSteps = [
    { id: '1', icon: 'lightbulb', title: 'Audit & Diagnostic', num: '01' },
    { id: '2', icon: 'layers', title: 'Stratégie & Simplification', num: '02' },
    { id: '3', icon: 'code', title: 'Architecture & Mise en œuvre', num: '03' },
    { id: '4', icon: 'test', title: 'Formation & Ancrage', num: '04' },
    { id: '5', icon: 'rocket', title: 'Suivi & Pérennisation', num: '05' },
  ];
        ...
        <div className="hidden lg:flex items-start justify-center gap-2 relative">
          ...
          {processSteps.map((step, index) => (
            ...
            >
              {/* Gold step number */}
              <span
                className="text-xs font-bold tracking-widest mb-2 z-10"
                style={{ color: '#c8a96e' }}
              >
                {step.num}
              </span>
