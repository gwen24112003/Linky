  ...
  const projects: Project[] = [
    {
      ...
      shortDescription: 'Petite phrase de description du projet 1',
    ...
    },
    {
      ...
      shortDescription: 'Petite phrase de description du projet 2',
      image: '/images/Logo_LP.jpg',
      technologies: [
      ...
      fullDescription: 'Deuxième projet avec une description complète qui sera révélée lors de l\'expansion.\n\nCe projet démontre nos capacités en automatisation et intégration de systèmes complexes.\n\nRésultats mesurables et satisfaction client garantie.',
      duration: '6 mois',
    ...
    },
    {
      ...
      company: "Nom de l'entreprise 3",
      shortDescription: 'Petite phrase de description du projet 3',
      image: '/images/Logo_LP.jpg',
      technologies: [
      ...
      fullDescription: 'Troisième projet démontrant notre expertise en solutions no-code.\n\nNous avons accompagné l\'équipe du début à la fin avec formation et support.\n\nUne solution clé en main qui répond parfaitement aux besoins.',
      duration: '3 mois',
      clientReview: 'Accompagnement exceptionnel'
    }
  ];
