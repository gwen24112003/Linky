        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative bg-gray-50 px-10 py-20 lg:px-16 flex flex-col justify-center overflow-hidden">
            ...
            >
              ...
              {[
                { icon: <Users size={20} className="text-teal-400" />, label: 'Réseau', text: 'Missions en co-traitance' },
                { icon: <Briefcase size={20} className="text-teal-400" />, label: 'Projets', text: 'PME & ETI ambitieuses' },
                { icon: <Star size={20} className="text-teal-400" />, label: 'Profils', text: 'Experts & Consultants seniors' },
              ].map(({ icon, label, text }) => (
                <motion.div
                  key={label}
                  ...
                  whileHover={{ background: 'rgba(13,148,136,0.08)', x: 4 }}
          ...
          <div className="bg-white px-10 py-20 lg:px-16 flex flex-col justify-center relative overflow-hidden">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 block">Pourquoi rejoindre Linky ?</label>
